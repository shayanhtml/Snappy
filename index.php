...
<div class="index-wrapper">
    <div class="info-box" style='font-family:Poppins'>
        <div class="info-inner">
            ...
            <div class="info-in-body">
                <div class="in-b-box">
                    <div class="in-b-img" style="border:4px solid white">
            ...
            <div class="post-footer">
                <div class="p-fo-left">
                    <ul>
                        ...
                        <label for="fileToUpload"> <i class="fa-solid fa-camera" style="margin:35px 30px;font-size:22px;"></i></label>
                        <span class="tweet-error"></span>
                        <input id="sub-btn" type="submit" name="post" value="Post" style="margin:30px 60px; background-color:#1DBF73;">
                    </ul>
                    </form>
                </div>
            </div>
