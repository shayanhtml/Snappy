...
<head>
    <title></title>
    <link rel="stylesheet" type="text/css" href="assets/new2.css">
</head>
...
<body>
    ...
    <form action="comment_frame.php?post_id=<?php echo $post_id; ?>" id="comment_form" name="postComment<?php echo $post_id; ?>" method="post" style="margin-bottom:10px;">
        <textarea name="post_body" style="width: 83%; border: none; border-radius: 5px; padding: 10px 0 0 10px;"></textarea>
        <input class="post-comment" type="submit" name="postComment<?php echo $post_id; ?>" value="Comment" style="padding: 2px 10px; cursor:pointer; background: #1DBF73; border: none; border-radius: 5px; color: white; margin-left: 10px; position: absolute; height: 28%;">
    </form>
