        ...
        <div class="msg_wreper">
            <form action="" method="post">
                ...
                if ($user_to == "new") {
                    ...
                    echo "<input type='submit' name='submit_msg' value='Send' id='send-btn'>";
                }
                ?>
            </form>
        </div>
...
<div class="old_chats">
    <div class="find_user">
        <center><a style="color:white;" href="messages.php?u=new"> Find User </a></center>
    </div>
    <div class="chat_wreper">
        <div class="headding">
            <span class="head">
                <center>Old Chats</center>
            </span>
        </div>
        <div class="chats">
