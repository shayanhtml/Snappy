...
<div class="profile_top">
    ...
    ?>
    <div class="btns" style="display: flex; margin: -15px 500px; background-color:red;">
        <form action="#" method="POST">
            <button class="message" name="send_msg"
                style="background-color:#1DBF73; display:flex; align-items:center;gap:10px;cursor:pointer;border-radius:5px;"><i
                    class="fa-solid fa-envelope" style="color:white;"></i> Message</button>
        </form>
        ...
        if ($username == $added_by) {
            ...
            if ($interval->y >= 1) {
                if ($interval == 1)
                    if ($interval !== false) {
                        ...
                        if ($interval !== false) {
                            if ($interval !== false) {
                                if ($interval !== false && is_object($interval)) {
            ...
            $ret_str .= "
                                        ...
                                        <div calss='post_feature'>
                                            ...
                                            <span class='comment' style='color: #3875c5; font-size: 12px; float: right; margin-right: 40px; margin-top:-10px;display:flex;align-items:center;gap:5px;cursor:pointer;'  onClick='javascript:toggle$id()'><i class=\"fa-regular fa-comment\"></i>($comment_check_num)</span>&nbsp;&nbsp;
