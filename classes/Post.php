                    ...
                    $imagePath = $row['image'];
                        ...
                        $ret_str .= "
                            ...
                            <div class='post_feature'>
                                <div class='comImg_comCount' style='display: flex; float: right; margin: 0 40px;align-items:center;'>
                                    <span class='comment' onClick='javascript:toggle$id();'><i class=\"fa-regular fa-comment\"></i></span> 
